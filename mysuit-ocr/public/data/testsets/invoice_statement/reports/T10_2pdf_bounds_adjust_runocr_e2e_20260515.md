...
## 1. 생성 파일
- Script: `D:\Free_Vue\OCR\ocr-server\scripts\verify_invoice_statement_template_runocr_e2e_t10_2pdf_bounds_adjust.py`
- Markdown report: `D:\Free_Vue\OCR\mysuit-ocr\public\data\testsets\invoice_statement\reports\T10_2pdf_bounds_adjust_runocr_e2e_20260515.md`
- JSON report: `D:\Free_Vue\OCR\mysuit-ocr\public\data\testsets\invoice_statement\reports\T10_2pdf_bounds_adjust_runocr_e2e_20260515.json`
...
- summary/잔액 row 포함 여부: true ["합계", "공급금액합계", "소비자금액합계", "전일잔액", "당일거래금액", "누계잔액", "구분", "채 권", "약정"]
...
| 문제 | 원인 | 후속 |
|---|---|---|
| 2.pdf rowCount over | 18/13 | tableBounds 하단 y 재조정 |
| 2.pdf summary/잔액 row 포함 | 합계, 공급금액합계, 소비자금액합계, 전일잔액, 당일거래금액, 누계잔액, 구분, 채 권, 약정 | 구분/채권/약정 영역 제외 후 재저장 |
