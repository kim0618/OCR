...
import type { FieldType, LoadedImage, Region, TableColumnDef } from "../../ocr/core/types";
import { normalizeRatios, calcMultiSubRegions } from "../../ocr/core/ops";
import { normalizeColGuides } from "../../ocr/core/table";
