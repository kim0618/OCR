  ...
  const docTypeSummary = useMemo((): DocTypeSummaryRow[] | null => {
    ...
    const ensure = (dt: string): DocTypeSummaryRow => {
      if (!map.has(dt)) {
        ...
        map.set(dt, { documentType: dt, total: 0, selected: 0, suppressed: 0, unknown: 0, error: 0, notRun: 0, fieldFilled, financeFieldFilled, documentFieldFilled, tableRowsWithData: 0, tableRowsWarningCount: 0 });
      }
      return map.get(dt)!;
    };
