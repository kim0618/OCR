...
type Props = {
  ...
  onClose: () => void;
  onCreate: (form: HistoryPopupForm) => Promise<void> | void;
};
...
function createDefaultValue(): HistoryPopupForm {
  return {
    file_name: "",
    template_name: null,
    processing_time: 0,
...
export default function CreateHistoryPopup({
  open,
  templateOptions,
  onClose,
  onCreate,
}: Props) {
  const [form, setForm] = useState<HistoryPopupForm>(createDefaultValue);
  ...
  return (
    <div style={overlayStyle} onMouseDown={onClose}>
      <div style={panelStyle} onMouseDown={(e) => e.stopPropagation()}>
        ...
        >
          <div>
            <div style={{ fontSize: 16, fontWeight: 900, color: "var(--accent)" }}>히스토리 추가</div>
        ...
        >
          ...
          <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <input
              list="history-template-options-create"
          ...
          <datalist id="history-template-options-create">
