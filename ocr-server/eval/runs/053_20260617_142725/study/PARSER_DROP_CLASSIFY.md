...
Defects scored (mismatch|ext_missing): **351**  |  parser-drop (OCR read it, recoverable): **200**  |  recognition (OCR-bound): **151**
Parser-recoverable share of defects: **57.0%**
...
## Parser-drops by column × pattern — ANGLE variants  (n=171)
...
## Parser-drops by column × pattern — ALL  (n=200)
