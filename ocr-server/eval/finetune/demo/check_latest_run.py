...
# ★기준 = wf80(1단계 최종 채택본, 2026-08-10). 0.8×v16 + 0.2×base 보간.
#  새 run(및 그 보간)의 채택 여부는 이 값(①글자 231 / 정답 38,527 / 타깃 26/26)을
#  넘느냐로 정한다. v16(260807_1302)은 학습 최선이었으나 wf80 이 두 지표 모두 우위.
BASELINE = "260810_wf80"
