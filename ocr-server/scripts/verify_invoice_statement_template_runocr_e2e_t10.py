"""
T-10: invoice_statement Template annotation RunOCR E2E re-verification.
...
OUT_JSON = REPORT_DIR / "T10_template_annotation_runocr_e2e_invoice_statement_20260514.json"
OUT_MD = REPORT_DIR / "T10_template_annotation_runocr_e2e_invoice_statement_20260514.md"
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines: list[str] = []
    lines.append("# T-10 invoice_statement Template annotation RunOCR E2E 재검증 결과")
    lines.append("")
